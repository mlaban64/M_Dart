...
package X.Strings is
   ...
   function Value (Item : in const_charp; Length : in Interfaces.C.size_t) return String;
   pragma Inline (Value);
   ...
   function Strlen (Item : in Interfaces.C.char_array) return Interfaces.C.size_t;
   pragma Inline (Strlen);
   ...
   function Cat (Left, Right : Interfaces.C.char_array) return Interfaces.C.char_array;
