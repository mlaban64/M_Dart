...
package Stdarg.Impl is
   ...
   procedure Do_Varargs (Proc : in System.Address; Nb_Args : Int; Arg_Addr : Param_Access);
...
private
   ...
   package Arith is new Interfaces.C.Pointers (Integer, C_Param, Stdarg.ArgVector, 0);
