...
package body X.Strings is
   ...
   function To_X is new Ada.Unchecked_Conversion (Interfaces.C.Strings.chars_ptr, charp);

   function To_X is new Ada.Unchecked_Conversion (const_charp, charp);

   function To_X is new Ada.Unchecked_Conversion (System.Address, charp);

   function To_X is new Ada.Unchecked_Conversion (System.Address, const_charp);

   function To_C is new Ada.Unchecked_Conversion (charp, Interfaces.C.Strings.chars_ptr);
   ...
   function Value (Item : in const_charp; Length : in Interfaces.C.size_t) return String is
   begin
      return Interfaces.C.Strings.Value (To_C (To_X (Item)), Length);
   end Value;
   ...
   function Strlen (Item : in Interfaces.C.char_array) return Interfaces.C.size_t is
   begin
   ...
   function Cat (Left, Right : Interfaces.C.char_array) return Interfaces.C.char_array is
