...
package X.Xlib is
   ...
   --  Xlib.h:1094
   XNPreeditStartCallback : constant Char_Array := "preeditStartCallback" & Nul; --  Xlib.h:1095
   XNPreeditDoneCallback  : constant Char_Array := "preeditDoneCallback" & Nul; --  Xlib.h:1096
   XNPreeditDrawCallback  : constant Char_Array := "preeditDrawCallback" & Nul; --  Xlib.h:1097
   XNPreeditCaretCallback : constant Char_Array := "preeditCaretCallback" & Nul; --  Xlib.h:1098
   XNPreeditAttributes    : constant Char_Array := "preeditAttributes" & Nul;
   --  Xlib.h:1099
   XNStatusStartCallback : constant Char_Array := "statusStartCallback" & Nul; --  Xlib.h:1100
   ...
   type Char32 is                                          --  Xlib.h:433
     array (Integer range 0 .. 31) of aliased X.signed_char;

   type Char20 is                                          --  Xlib.h:894
     array (Integer range 0 .. 19) of aliased X.signed_char;

   type Short10 is                                         --  Xlib.h:895
     array (Integer range 0 .. 9) of aliased X.signed_short;

   type Long5 is                                           --  Xlib.h:896
     array (Integer range 0 .. 4) of aliased X.long;
   ...
   type af_351_destroy_image is access function (Image : access XImage) return X.signed_int;
   --  Xlib.h:351
   ...
   type af_467_resource_alloc is access function (Dpy : access XDisplay) return X.XID; --  Xlib.h:4
                                                                                       --67
   ...
   type XClientMessageEvent_Inner (format : MessageEventFormats := F8) is record
      case format is
         when F8 =>
            b : Char20;                              --  Xlib.h:894
         when F16 =>
   ...
   type XIMText_Inner (encoding_is_wchar : Bool := False) is record
   ...
   type XIMStatusDrawCallbackStruct (c_type : XIMStatusDataType := XIMTextType) is record --  Xlib.
                                                                                          --h
                                                                                          --:1186
      case c_type is
         when XIMTextType =>
   ...
   type XIOErrorHandler is access function (display : access XDisplay) return X.signed_int;
   --  Xlib.h:1781
   ...
   type event_vector is                                    --  Xlib.h:511
     array (Integer range 0 .. 127) of aliased event_func;

   type wire_func is access function return Status;

   type wire_vector is                                     --  Xlib.h:512
     array (Integer range 0 .. 127) of aliased wire_func;
   ...
   function XQueryFont (display : access XDisplay; font_ID : X.XID) return XFontStruct_access;
   --  Xlib.h:1203
   ...
   function XGetModifierMapping (display : access XDisplay) return XModifierKeymap_access;   --  Xl
                                                                                             --i
                                                                                             --  b.
                                                                                             --h:
                                                                                             --  12
   ...
   function XNewModifiermap (max_keys_per_mod : X.signed_int) return XModifierKeymap_access;
   --  Xlib.h:1251
   ...
   function XOpenDisplay (display_name : X.Strings.const_charp) return XDisplay_access;   --  Xlib.
                                                                                          --h
                                                                                          --:1302

   pragma Import (C, XOpenDisplay, "XOpenDisplay");

   function XOpenDisplay (display_name : Interfaces.C.char_array) return XDisplay_access; --  Xlib.
                                                                                          --h
                                                                                          --:1302
   ...
   function XGetAtomName (display : access XDisplay; atom : X.Atom) return X.Strings.charp;
   --  Xlib.h:1327
   ...
   function XDisplayName (string : X.Strings.const_charp) return X.Strings.charp; --  Xlib.h:1340

   pragma Import (C, XDisplayName, "XDisplayName");

   function XDisplayName (string : Interfaces.C.char_array) return X.Strings.charp; --  Xlib.h:1340

   pragma Inline (Xdisplayname);

   function XKeysymToString (keysym : X.KeySym) return X.Strings.charp; --  Xlib.h:1345
   ...
   type af_1360_func is access function (display : access XDisplay) return X.signed_int;  --  Xlib.
                                                                                          --h
                                                                                          --:1360
   ...
   function XLoadFont (display : access XDisplay; name : X.Strings.const_charp) return X.Font;
   --  Xlib.h:1416

   pragma Import (C, XLoadFont, "XLoadFont");

   function XLoadFont (display : access XDisplay; name : Interfaces.C.char_array) return X.Font;
   --  Xlib.h:1416
   ...
   function XGContextFromGC (gc : access XGC) return X.GContext; --  Xlib.h:1430

   procedure XFlushGC (display : access XDisplay; gc : access XGC); --  Xlib.h:1435
   ...
   function XGetSelectionOwner (display : access XDisplay; selection : X.Atom) return X.Window;
   --  Xlib.h:1484
   ...
   function XStringToKeysym (string : X.Strings.const_charp) return X.KeySym; --  Xlib.h:1585

   pragma Import (C, XStringToKeysym, "XStringToKeysym");

   function XStringToKeysym (string : Interfaces.C.char_array) return X.KeySym; --  Xlib.h:1585

   pragma Inline (Xstringtokeysym);

   function XMaxRequestSize (display : access XDisplay) return X.long; --  Xlib.h:1590

   function XResourceManagerString (display : access XDisplay) return X.Strings.charp; --  Xlib.h:1
                                                                                       --5
                                                                                       --95

   function XScreenResourceString (screen : Screen_access) return X.Strings.charp; --  Xlib.h:1600

   function XDisplayMotionBufferSize (display : access XDisplay) return X.unsigned_long;  --  Xlib.
                                                                                          --h
                                                                                          --:1605

   function XVisualIDFromVisual (visual : Visual_access) return X.VisualID; --  Xlib.h:1610
   ...
   function XAddExtension (display : access XDisplay) return XExtCodes_access; --  Xlib.h:1625
   ...
   function XEHeadOfExtensionList (object : XEDataObject) return XExtData_access_access;  --  Xlib.
                                                                                          --h
                                                                                          --:1636
   ...
   function XDefaultRootWindow (display : access XDisplay) return X.Window; --  Xlib.h:1649

   function XRootWindowOfScreen (screen : Screen_access) return X.Window; --  Xlib.h:1654
   ...
   function XDefaultVisualOfScreen (screen : Screen_access) return Visual_access; --  Xlib.h:1665

   function XDefaultGC (display : access XDisplay; screen_number : X.signed_int) return GC;
   --  Xlib.h:1670

   function XDefaultGCOfScreen (screen : Screen_access) return GC; --  Xlib.h:1676
   ...
   function XBlackPixelOfScreen (screen : Screen_access) return X.unsigned_long; --  Xlib.h:1698

   function XWhitePixelOfScreen (screen : Screen_access) return X.unsigned_long; --  Xlib.h:1703

   function XNextRequest (display : access XDisplay) return X.unsigned_long; --  Xlib.h:1708

   function XLastKnownRequestProcessed (display : access XDisplay) return X.unsigned_long;   --  Xl
                                                                                             --i
                                                                                             --b.h:
                                                                                             --1713

   function XServerVendor (display : access XDisplay) return X.Strings.charp; --  Xlib.h:1718

   function XDisplayString (display : access XDisplay) return X.Strings.charp; --  Xlib.h:1723
   ...
   function XDefaultColormapOfScreen (screen : Screen_access) return X.Colormap; --  Xlib.h:1734

   function XDisplayOfScreen (screen : Screen_access) return XDisplay_access; --  Xlib.h:1739
   ...
   function XDefaultScreenOfDisplay (display : access XDisplay) return Screen_access;  --  Xlib.h:1
                                                                                       --7
                                                                                       --50

   function XEventMaskOfScreen (screen : Screen_access) return X.long; --  Xlib.h:1755

   function XScreenNumberOfScreen (screen : Screen_access) return X.signed_int; --  Xlib.h:1761

   function XSetErrorHandler (handler : XErrorHandler) return XErrorHandler; --  Xlib.h:1774

   function XSetIOErrorHandler (handler : XIOErrorHandler) return XIOErrorHandler; --  Xlib.h:1787
   ...
   procedure XFreeStringList (list : X.Strings.charp_vector);              --  Xlib.h:1874
   ...
   procedure XActivateScreenSaver (display : access XDisplay);                  --  Xlib.h:1889

   procedure XAddHost (display : access XDisplay; host : access XHostAddress); --  Xlib.h:1895
   ...
   procedure XAddToSaveSet (display : access XDisplay; w : X.Window); --  Xlib.h:1917
   ...
   procedure XAllowEvents (display : access XDisplay; event_mode : X.signed_int; time : X.Time);
   --  Xlib.h:1970

   procedure XAutoRepeatOff (display : access XDisplay);                  --  Xlib.h:1978

   procedure XAutoRepeatOn (display : access XDisplay);                  --  Xlib.h:1984

   procedure XBell (display : access XDisplay; percent : X.signed_int); --  Xlib.h:1990

   function XBitmapBitOrder (display : access XDisplay) return X.signed_int; --  Xlib.h:1997

   function XBitmapPad (display : access XDisplay) return X.signed_int; --  Xlib.h:2003

   function XBitmapUnit (display : access XDisplay) return X.signed_int; --  Xlib.h:2009

   function XCellsOfScreen (screen : Screen_access) return X.signed_int; --  Xlib.h:2015
   ...
   procedure XCirculateSubwindowsDown (display : access XDisplay; w : X.Window); --  Xlib.h:2155

   procedure XCirculateSubwindowsUp (display : access XDisplay; w : X.Window); --  Xlib.h:2162
   ...
   procedure XClearWindow (display : access XDisplay; w : X.Window); --  Xlib.h:2181

   procedure XCloseDisplay (display : access XDisplay);                  --  Xlib.h:2188
   ...
   function XConnectionNumber (display : access XDisplay) return X.signed_int; --  Xlib.h:2203
   ...
   function XDefaultDepthOfScreen (screen : Screen_access) return X.signed_int; --  Xlib.h:2267

   function XDefaultScreen (display : access XDisplay) return X.signed_int; --  Xlib.h:2273

   procedure XDefineCursor (display : access XDisplay; w : X.Window; cursor : X.Cursor);  --  Xlib.
                                                                                          --h
                                                                                          --  :2279

   procedure XDeleteProperty (display : access XDisplay; w : X.Window; property : X.Atom);   --  Xl
                                                                                             --i
                                                                                             --  b.
                                                                                             --h:
                                                                                             --  22
   ...
   procedure XDestroyWindow (display : access XDisplay; w : X.Window); --  Xlib.h:2295

   procedure XDestroySubwindows (display : access XDisplay; w : X.Window); --  Xlib.h:2302

   function XDoesBackingStore (screen : Screen_access) return X.signed_int; --  Xlib.h:2309

   function XDoesSaveUnders (screen : Screen_access) return Bool; --  Xlib.h:2315

   procedure XDisableAccessControl (display : access XDisplay);                  --  Xlib.h:2321
   ...
   procedure XEnableAccessControl (display : access XDisplay);                  --  Xlib.h:2550

   function XEventsQueued (display : access XDisplay; mode : X.signed_int) return X.signed_int;
   --  Xlib.h:2556
   ...
   procedure XFlush (display : access XDisplay);                  --  Xlib.h:2629

   procedure XForceScreenSaver (display : access XDisplay; mode : X.signed_int); --  Xlib.h:2635

   procedure XFree (data : System.Address);                      --  Xlib.h:2642

   procedure XFreeColormap (display : access XDisplay; colormap : X.Colormap); --  Xlib.h:2648
   ...
   procedure XFreeCursor (display : access XDisplay; cursor : X.Cursor); --  Xlib.h:2665

   procedure XFreeExtensionList (list : X.Strings.charp_vector);              --  Xlib.h:2672

   procedure XFreeFont (display : access XDisplay; font_struct : access XFontStruct);  --  Xlib.h:2
                                                                                       --6
                                                                                       --  78
   ...
   function XFreeFontNames (list : X.Strings.charp_vector) return X.signed_int; --  Xlib.h:2693

   procedure XFreeFontPath (list : X.Strings.charp_vector);              --  Xlib.h:2699

   procedure XFreeGC (display : access XDisplay; gc : access XGC);   --  Xlib.h
                                                                     --  :2705

   procedure XFreeModifiermap (modmap : access XModifierKeymap);            --  Xlib.h:2712

   procedure XFreePixmap (display : access XDisplay; pixmap : X.Pixmap); --  Xlib.h:2718
   ...
   procedure XGrabServer (display : access XDisplay);                  --  Xlib.h:2929

   function XHeightMMOfScreen (screen : Screen_access) return X.signed_int; --  Xlib.h:2935

   function XHeightOfScreen (screen : Screen_access) return X.signed_int; --  Xlib.h:2941
   ...
   function XImageByteOrder (display : access XDisplay) return X.signed_int; --  Xlib.h:2962

   procedure XInstallColormap (display : access XDisplay; colormap : X.Colormap); --  Xlib.h:2968

   function XKeysymToKeycode (display : access XDisplay; keysym : X.KeySym) return X.KeyCode;
   --  Xlib.h:2975

   procedure XKillClient (display : access XDisplay; resource : X.XID); --  Xlib.h:2982
   ...
   procedure XLowerWindow (display : access XDisplay; w : X.Window); --  Xlib.h:3005

   procedure XMapRaised (display : access XDisplay; w : X.Window); --  Xlib.h:3012

   procedure XMapSubwindows (display : access XDisplay; w : X.Window); --  Xlib.h:3019

   procedure XMapWindow (display : access XDisplay; w : X.Window); --  Xlib.h:3026
   ...
   function XMaxCmapsOfScreen (screen : Screen_access) return X.signed_int; --  Xlib.h:3041

   function XMinCmapsOfScreen (screen : Screen_access) return X.signed_int; --  Xlib.h:3047
   ...
   procedure XNextEvent (display : access XDisplay; event_return : access XEvent); --  Xlib.h:3073

   procedure XNoOp (display : access XDisplay);                  --  Xlib.h:3080
   ...
   procedure XPeekEvent (display : access XDisplay; event_return : access XEvent); --  Xlib.h:3105
   ...
   function XPending (display : access XDisplay) return X.signed_int; --  Xlib.h:3127

   function XPlanesOfScreen (screen : Screen_access) return X.signed_int; --  Xlib.h:3133

   function XProtocolRevision (display : access XDisplay) return X.signed_int; --  Xlib.h:3140

   function XProtocolVersion (display : access XDisplay) return X.signed_int; --  Xlib.h:3146

   procedure XPutBackEvent (display : access XDisplay; event : access XEvent); --  Xlib.h:3153
   ...
   function XQLength (display : access XDisplay) return X.signed_int; --  Xlib.h:3175
   ...
   procedure XQueryKeymap (display : access XDisplay; keys_return : access Char32); --  Xlib.h:3253
   ...
   procedure XRaiseWindow (display : access XDisplay; w : X.Window); --  Xlib.h:3311
   ...
   procedure XRefreshKeyboardMapping (event_map : access XMappingEvent);           --  Xlib.h:3351

   procedure XRemoveFromSaveSet (display : access XDisplay; w : X.Window); --  Xlib.h:3357

   procedure XRemoveHost (display : access XDisplay; host : access XHostAddress); --  Xlib.h:3364
   ...
   procedure XResetScreenSaver (display : access XDisplay);                  --  Xlib.h:3389
   ...
   procedure XRotateBuffers (display : access XDisplay; rotate : X.signed_int); --  Xlib.h:3412
   ...
   function XScreenCount (display : access XDisplay) return X.signed_int; --  Xlib.h:3429

   procedure XSelectInput (display : access XDisplay; w : X.Window; event_mask : X.long); --  Xlib.
                                                                                          --h
                                                                                          --:3435
   ...
   procedure XSetAccessControl (display : access XDisplay; mode : X.signed_int); --  Xlib.h:3453

   procedure XSetArcMode (display : access XDisplay; gc : access XGC; arc_mode : X.signed_int);
   --  Xlib.h:3460
   ...
   procedure XSetClipMask (display : access XDisplay; gc : access XGC; pixmap : X.Pixmap);   --  Xl
                                                                                             --i
                                                                                             --b.h:
                                                                                             --3476
   ...
   procedure XSetCloseDownMode (display : access XDisplay; close_mode : X.signed_int); --  Xlib.h:3
                                                                                       --5
                                                                                       --  05
   ...
   procedure XSetFont (display : access XDisplay; gc : access XGC; font : X.Font); --  Xlib.h:3547
   ...
   procedure XSetStipple (display : access XDisplay; gc : access XGC; stipple : X.Pixmap);   --  Xl
                                                                                             --i
                                                                                             --  b.
                                                                                             --h:
                                                                                             --  36
   ...
   procedure XSetTile (display : access XDisplay; gc : access XGC; tile : X.Pixmap);   --  Xlib.h:3
                                                                                       --6
                                                                                       --  93
   ...
   procedure XSync (display : access XDisplay; discard : Bool); --  Xlib.h:3801
   ...
   procedure XUndefineCursor (display : access XDisplay; w : X.Window); --  Xlib.h:3861
   ...
   procedure XUngrabKeyboard (display : access XDisplay; time : X.Time); --  Xlib.h:3886

   procedure XUngrabPointer (display : access XDisplay; time : X.Time); --  Xlib.h:3893

   procedure XUngrabServer (display : access XDisplay);                  --  Xlib.h:3900

   procedure XUninstallColormap (display : access XDisplay; colormap : X.Colormap); --  Xlib.h:3906

   procedure XUnloadFont (display : access XDisplay; font : X.Font); --  Xlib.h:3913

   procedure XUnmapSubwindows (display : access XDisplay; w : X.Window); --  Xlib.h:3920

   procedure XUnmapWindow (display : access XDisplay; w : X.Window); --  Xlib.h:3927

   function XVendorRelease (display : access XDisplay) return X.signed_int; --  Xlib.h:3934
   ...
   function XWidthMMOfScreen (screen : Screen_access) return X.signed_int; --  Xlib.h:3954

   function XWidthOfScreen (screen : Screen_access) return X.signed_int; --  Xlib.h:3960
   ...
   function XSetLocaleModifiers (modifier_list : X.Strings.const_charp) return X.Strings.charp;
   --  Xlib.h:3993
   ...
   procedure XFreeFontSet (display : access XDisplay; font_set : XFontSet); --  Xlib.h:4009
   ...
   function XBaseFontNameListOfFontSet (font_set : XFontSet) return X.Strings.charp;   --  Xlib.h:4
                                                                                       --0
                                                                                       --  24

   function XLocaleOfFontSet (font_set : XFontSet) return X.Strings.charp; --  Xlib.h:4030

   function XContextDependentDrawing (font_set : XFontSet) return Bool; --  Xlib.h:4036

   function XExtentsOfFontSet (font_set : XFontSet) return XFontSetExtents_access; --  Xlib.h:4042
   ...
   function XCloseIM (im : XIM) return Status;                               --  Xlib.h:4197
   ...
   function XDisplayOfIM (im : XIM) return XDisplay_access;                      --  Xlib.h:4209

   function XLocaleOfIM (im : XIM) return X.Strings.charp;                      --  Xlib.h:4215

   function XCreateIC (im : XIM; args : Stdarg.ArgList := Stdarg.Empty) return XIC; --  Xlib.h:4221

   procedure XDestroyIC (ic : XIC);                                   --  Xlib.h:4227

   procedure XSetICFocus (ic : XIC);                                   --  Xlib.h:4233

   procedure XUnsetICFocus (ic : XIC);                                   --  Xlib.h:4239

   function XwcResetIC (ic : XIC) return X.wchar_access;                       --  Xlib.h:4245

   function XmbResetIC (ic : XIC) return X.Strings.charp;                      --  Xlib.h:4251
   ...
   function XIMOfIC (ic : XIC) return XIM;                                  --  Xlib.h:4269

   function XFilterEvent (event : access XEvent; window : X.Window) return Bool; --  Xlib.h:4275
   ...
   function RootWindow (Dpy : access XDisplay; Scr : X.signed_int) return X.Window;
   ...
   function DefaultVisual (Dpy : access XDisplay; Scr : X.signed_int) return Visual_access;

   function DefaultGC (Dpy : access XDisplay; Scr : X.signed_int) return GC;

   function BlackPixel (Dpy : access XDisplay; Scr : X.signed_int) return X.unsigned_long;

   function WhitePixel (Dpy : access XDisplay; Scr : X.signed_int) return X.unsigned_long;

   function QLength (Dpy : access XDisplay) return X.signed_int;

   function DisplayWidth (Dpy : access XDisplay; Scr : X.signed_int) return X.signed_int;

   function DisplayHeight (Dpy : access XDisplay; Scr : X.signed_int) return X.signed_int;

   function DisplayWidthMM (Dpy : access XDisplay; Scr : X.signed_int) return X.signed_int;

   function DisplayHeightMM (Dpy : access XDisplay; Scr : X.signed_int) return X.signed_int;

   function DisplayPlanes (Dpy : access XDisplay; Scr : X.signed_int) return X.signed_int;

   function DisplayCells (Dpy : access XDisplay; Scr : X.signed_int) return X.signed_int;
   ...
   function DefaultDepth (Dpy : access XDisplay; Scr : X.signed_int) return X.signed_int;

   function DefaultColormap (Dpy : access XDisplay; Scr : X.signed_int) return X.Colormap;
   ...
   function LastKnownRequestProcessed (Dpy : access XDisplay) return X.unsigned_long;

   function ScreenOfDisplay (Dpy : access XDisplay; Scr : X.signed_int) return Screen_access;
